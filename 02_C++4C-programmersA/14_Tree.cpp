...
public:
    ...
    // Find the shortest path between vertices u and v
...
void ShortestPath::display_path(){
    ...
    cout << "Shortest path between vertices #" << _v << " and #" << _w << endl;
...
int main() {
    ...
    // Creating vertex and edges pointers
    ...
    cout << "Printing the adjacencies of the " << *(*graph)[0] << endl;
    (*graph)[0]->display_adjacencies();

    // Creating a shortest_path instance
